...
$remote = (Invoke-WebRequest -Uri "https://raw.githubusercontent.com/cofm34/awf-antigrivity/main/VERSION" -UseBasicParsing).Content.Trim()
...
echo "REMOTE: $(curl -s https://raw.githubusercontent.com/cofm34/awf-antigrivity/main/VERSION)"
```
